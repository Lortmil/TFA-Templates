...
_deploymentPositions = missionNamespace getVariable "Deployment_Positions";

// Creates markers on map for deployment positions 
{
	_markerName = "DeploymentMarker" + str _foreachindex;
...
while {str findDisplay 441234 == "Display #441234"} do { 
	...
	_selectedMarker = "DeploymentMarker" + str _selectedDeployment;
