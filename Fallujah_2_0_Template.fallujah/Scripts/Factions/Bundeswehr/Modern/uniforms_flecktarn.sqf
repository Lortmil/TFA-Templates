...
switch (_loadout) do {
	...
	case "plt": {player addBackpack "tfw_ilbe_whip_wd2"};
	case "logi": {player addBackpack "tfw_ilbe_whip_wd2"};
	case "tacp": {player addBackpack "tfw_ilbe_whip_wd2"};
	case "sqd_ld": {player addBackpack "tfw_ilbe_whip_wd2"};
	case "rcn_ld": {player addBackpack "tfw_ilbe_whip_wd2"};
	case "rcn_spe";
	case "sqd_med": {player addBackpack "BWA3_Kitbag_Fleck_Medic"};
	case "sup_aa_l": {player addBackpack "tfw_ilbe_whip_wd2"};
	case "sup_mmg_l": {player addBackpack "tfw_ilbe_whip_wd2"};
	case "sup_mat_l": {player addBackpack "tfw_ilbe_whip_wd2"};
