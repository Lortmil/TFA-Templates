...
_spawnPosition = synchronizedObjects (player getVariable "Vehicle_Master") select _indexSpawn;

player setVariable ["Motorpool_Memory_Side", _indexSide];
player setVariable ["Motorpool_Memory_Faction", _indexFaction];
player setVariable ["Motorpool_Memory_Vehicle", _indexVehicle];
player setVariable ["Motorpool_Memory_Spawn", _indexSpawn];
