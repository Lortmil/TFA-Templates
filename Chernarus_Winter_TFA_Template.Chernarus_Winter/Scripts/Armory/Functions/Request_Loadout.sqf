...
player setVariable ["Armory_Memory_Side", _indexSide];
player setVariable ["Armory_Memory_Faction", _savedFaction];
player setVariable ["Armory_Memory_Loadout", _indexLoadout];
...
player setVariable ["Player_side", _side, true];
player setVariable ["Player_faction", _faction, true];
player setVariable ["Player_variant", _variant, true];
player setVariable ["player_loadout", _loadout, true];
