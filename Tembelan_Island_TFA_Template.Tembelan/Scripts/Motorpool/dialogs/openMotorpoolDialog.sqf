...
_sideMemory = player getVariable ["Motorpool_Memory_Side", -1];
_spawnMemory = player getVariable ["Motorpool_Memory_Spawn", -1];

player setVariable ["Vehicle_Master", _vehicleMaster];
