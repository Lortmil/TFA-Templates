params ["_crate"];
_deployment = missionNamespace getVariable "Deployment_Positions";
...
missionNamespace setVariable ["Deployment_Positions", _deployment, true];
...
[[_buildArea],"Scripts\Resupply\Functions\Create_Build_Area.sqf"] remoteExec ["execVM", 0, _spawn];
