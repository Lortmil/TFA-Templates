...
switch (_loadout) do {
	...
	case "sqd_ar": { player addBackpack "UK3CB_BAF_B_Bergen_MTP_Medic_L_B"};
	case "sqd_aar";
	case "sup_mmg_l": { player addBackpack "UK3CB_BAF_B_Bergen_MTP_Medic_L_B"};
	...
	case "sqd_lat";
	case "sup_hat_l": : { player addBackpack "UK3CB_BAF_B_Bergen_MTP_Medic_L_B"}
	case "sup_hat_g": { player addBackpack "UK3CB_BAF_B_Bergen_MTP_Rifleman_L_C"};
	case "rcn_ld": : { player addBackpack "UK3CB_BAF_B_Bergen_MTP_Medic_L_B"}
