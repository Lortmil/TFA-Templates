...
_spawnPosition = synchronizedObjects (player getVariable "Resupply_Master") select _indexSpawn;

player setVariable ["Resupply_Memory_Side", _indexSide];
player setVariable ["Resupply_Memory_Faction", _indexFaction];
player setVariable ["Resupply_Memory_Supply", _indexSupply];
player setVariable ["Resupply_Memory_Spawn", _indexSpawn];
