...
_sideMemory = player getVariable ["Resupply_Memory_Side", -1];
_spawnMemory = player getVariable ["Resupply_Memory_Spawn", -1];

player setVariable ["Resupply_Master", _resupplyMaster];
