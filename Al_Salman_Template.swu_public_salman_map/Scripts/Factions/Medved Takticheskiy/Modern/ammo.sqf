...
switch (_loadout) do {
	default {
		...
		for "_i" from 1 to 4 do { player addItemToVest "30Rnd_545x39_Mag_Tracer_F"};
	};
	case "sqd_ar": {
	...
	case "sqd_dmr";
	case "sqd_brc": {
		for "_i" from 1 to 4 do { player addItemToVest "hlc_10rnd_12g_buck_S12"};
		for "_i" from 1 to 4 do { player addItemToVest "hlc_10rnd_12g_slug_S12"};
	};
	case "rcn_dmr": {
	...
	case "pil": {
		...
		for "_i" from 1 to 2 do { player addItemToVest "30Rnd_545x39_Mag_Tracer_F"};
	};
};
